...
| **Joint-Optimization** | [optimization_with_label_attack.py](./breaching/breaching/attacks/optimization_with_label_attack.py) | Joint optimization of data and labels |
| **Permutation-Optimization** | [optimization_permutation_attack.py](./breaching/breaching/attacks/optimization_permutation_attack.py) | Optimization with batch permutation |
...
1. **[simulate_breach.py](./breaching/simulate_breach.py)** - Single attack simulation
2. **[benchmark_breaches.py](./breaching/benchmark_breaches.py)** - Benchmark over multiple trials
3. **[minimal_example.py](./breaching/minimal_example.py)** - Minimal standalone example
...
![Code Flow](breaching_code_flow.png)

### Detailed Attack Flow

![Attack Flow](attack_flow.png)
...
Edit [breaching/attacks/__init__.py](./breaching/breaching/attacks/__init__.py):
...
- **New regularizer**: Add to [breaching/attacks/auxiliaries/regularizers.py](./breaching/breaching/attacks/auxiliaries/regularizers.py)
- **New objective**: Add to [breaching/attacks/auxiliaries/objectives.py](./breaching/breaching/attacks/auxiliaries/objectives.py)
...
| Objectives | [auxiliaries/objectives.py](./breaching/breaching/attacks/auxiliaries/objectives.py) |
| Optimizers | [auxiliaries/common.py](./breaching/breaching/attacks/auxiliaries/common.py) |
...
| Minimal example | [minimal_example.py](./breaching/minimal_example.py) |
| **Core Module** | |
| Module init | [breaching/__init__.py](./breaching/breaching/__init__.py) |
| **Attacks** | |
| Attack factory | [attacks/__init__.py](./breaching/breaching/attacks/__init__.py) |
| Base class | [attacks/base_attack.py](./breaching/breaching/attacks/base_attack.py) |
| Optimization attack | [attacks/optimization_based_attack.py](./breaching/breaching/attacks/optimization_based_attack.py) |
| Analytic attack | [attacks/analytic_attack.py](./breaching/breaching/attacks/analytic_attack.py) |
| **Cases** | |
| Case factory | [cases/__init__.py](./breaching/breaching/cases/__init__.py) |
| Server impl | [cases/servers.py](./breaching/breaching/cases/servers.py) |
| User impl | [cases/users.py](./breaching/breaching/cases/users.py) |
| **Config** | |
| Main config | [config/cfg.yaml](./breaching/breaching/config/cfg.yaml) |
| Attack configs | [config/attack/](./breaching/breaching/config/attack) |
| Case configs | [config/case/](./breaching/breaching/config/case) |
| **Examples** | |
| Jupyter notebooks | [examples/](./breaching/examples) |
